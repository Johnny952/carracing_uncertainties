...
class VanillaVAE(nn.Module):
    ...
    def __init__(self,
        ...
        self.decode_input_dim = hidden_dims[-1]
        ...
        self.final_layer = nn.Sequential(
                            nn.Conv2d(hidden_dims[-1], out_channels= self._in_channels,
    ...
    def decode(self, z: Tensor) -> Tensor:
        ...
        result = result.view(-1, self.decode_input_dim, 3, 3)
    ...
    def loss_function(self,
        ...
        recons_loss = self.decoder_loss(recons, input)
